...
const Listdata = () => {
  ...
  const sortnamea = () => {
    axios.get("http://localhost:8000/sortnamea").then((res) => {
      setAns(res.data);
    });
  };
  const sortnamed = () => {
    axios.get("http://localhost:8000/sortnamed").then((res) => {
      console.log(res.data);
      setAns(res.data);
    });
  };
  const sortdatea = () => {
    axios.get("http://localhost:8000/sortdatea").then((res) => {
      console.log(res.data);
      setAns(res.data);
    });
  };
  ...
  function reset() {
    ...
    setDispstatus("");
    axios
      .get("http://localhost:8000/filterdata", {
